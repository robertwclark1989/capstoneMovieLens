...
The goal of this project is to build a movie recommendation system that is capable of predicting fairly accurate ratings. To do this, I will use the MovieLens dataset thta is publicly available. The dataset consists of ratings given to movies by users. The userId, movieId, rating, timestamp, movie title and the movie's genres are included. 
